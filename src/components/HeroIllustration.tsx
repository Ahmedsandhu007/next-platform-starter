...
export function HeroIllustration() {
  ...
  return (
    <svg viewBox="0 0 560 500" className="h-auto w-full" role="img" aria-label="Illustration of an accounting dashboard with charts and reports" fill="none">
      ...
      <circle cx="300" cy="240" r="220" stroke="#ee5935" strokeOpacity="0.12" strokeDasharray="2 8" />
      ...
      <g>
        ...
        <circle cx="148" cy="124" r="9" fill="#ee5935" />
        ...
        <rect x="392" y="118" width="28" height="14" rx="7" fill="#ee5935" />
        ...
        <path d="M372 200l5-6 4 4 7-8" stroke="#ee5935" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <rect x="284" y="252" width="30" height="80" rx="4" fill="#ee5935" />
        <rect x="326" y="268" width="30" height="64" rx="4" fill="#24282b" />
        <rect x="368" y="240" width="30" height="92" rx="4" fill="#ee5935" />
        {/* trend line */}
        <path d="M173 300 L215 286 L257 292 L299 262 L341 276 L383 250" stroke="#ee5935" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        {[173, 215, 257, 299, 341, 383].map((cx, i) => (
          <circle key={cx} cx={cx} cy={[300, 286, 292, 262, 276, 250][i]} r="3.4" fill="#ffffff" stroke="#ee5935" strokeWidth="2" />
        ))}
      ...
      {/* floating: £ coin */}
      <motion.g {...float(-10, 5)}>
        <circle cx="96" cy="150" r="34" fill="#ee5935" />
      ...
      <motion.g {...float(10, 6, 0.4)}>
        ...
        <path d="M446 149l4 4 7-8" stroke="#ee5935" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <motion.g {...float(-8, 6.5, 0.2)}>
        ...
        <path d="M106 340a26 26 0 0 1 22 39" stroke="#ee5935" strokeWidth="9" strokeLinecap="round" />
      ...
      <motion.g {...float(9, 5.5, 0.6)}>
        ...
        <rect x="436" y="386" width="34" height="12" rx="6" fill="#ee5935" />
      </motion.g>
    </svg>
  );
}
