...
export function SpotArt({ name, className = "" }: { name: Name; className?: string }) {
  ...
  if (name === "cloud") {
    return (
      <svg viewBox="0 0 220 180" aria-label="Cloud accounting illustration" {...common}>
        ...
        <circle cx="186" cy="44" r="6" fill="#ee5935" fillOpacity="0.5" />
        ...
        <path d="M96 70a22 22 0 0 1 17 20" stroke="#ee5935" strokeWidth="2.5" strokeLinecap="round" />
        {/* dashboard card */}
        ...
        <rect x="112" y="135" width="10" height="19" rx="2" fill="#ee5935" />
        <rect x="126" y="143" width="10" height="11" rx="2" fill="#cdd6df" />
        <rect x="84" y="126" width="34" height="5" rx="2.5" fill="#b7c0c9" />
        {/* sync */}
        <path d="M150 92a12 12 0 1 0 4 9" stroke="#ee5935" strokeWidth="2.5" strokeLinecap="round" />
        <path d="M150 84v8h-8" stroke="#ee5935" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  ...
  if (name === "advisory") {
    return (
      <svg viewBox="0 0 220 180" aria-label="Business advisory illustration" {...common}>
        <rect x="16" y="26" width="188" height="128" rx="20" fill="#ecf5fe" />
        <circle cx="40" cy="44" r="6" fill="#ee5935" fillOpacity="0.5" />
        ...
        <rect x="150" y="58" width="18" height="74" rx="3" fill="#ee5935" />
        {/* trend arrow */}
        <path d="M64 116l28-14 26 8 30-30" stroke="#ee5935" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M136 80h12v12" stroke="#ee5935" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="92" cy="102" r="4" fill="#ffffff" stroke="#ee5935" strokeWidth="2.5" />
        <circle cx="118" cy="110" r="4" fill="#ffffff" stroke="#ee5935" strokeWidth="2.5" />
      </svg>
    );
  }
  ...
  if (name === "bookkeeping") {
    return (
      <svg viewBox="0 0 220 180" aria-label="Bookkeeping illustration" {...common}>
        <rect x="16" y="26" width="188" height="128" rx="20" fill="#ecf5fe" />
        <circle cx="184" cy="46" r="6" fill="#ee5935" fillOpacity="0.5" />
        {/* ledger */}
        ...
        {[64, 78, 92, 106].map((y) => (
          <g key={y}>
            ...
            <rect x="120" y={y} width="22" height="5" rx="2.5" fill={y === 78 ? "#ee5935" : "#cbd3db"} />
          </g>
        ))}
        {/* pen + check */}
        <circle cx="160" cy="118" r="16" fill="#ee5935" />
  ...
  if (name === "payroll") {
    return (
      <svg viewBox="0 0 220 180" aria-label="Payroll illustration" {...common}>
        ...
        <rect x="100" y="119" width="28" height="8" rx="4" fill="#ee5935" />
        <circle cx="160" cy="66" r="22" fill="#ee5935" />
        ...
        <path d="M153 128c3 0 3.5-2 6.5-2M152 122h8M155 128v-9c0-2.5 2-4 4.5-4 1.1 0 2.1.5 3 1.3" stroke="#ee5935" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  ...
  if (name === "vat") {
    return (
      <svg viewBox="0 0 220 180" aria-label="VAT returns illustration" {...common}>
        ...
        <circle cx="156" cy="58" r="26" fill="#ee5935" />
        ...
        <path d="M143 118l5 5 9-10" stroke="#ee5935" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  ...
  if (name === "formation") {
    return (
      <svg viewBox="0 0 220 180" aria-label="Company formation illustration" {...common}>
        ...
        {[62, 80, 98].flatMap((y) =>
          [58, 76].map((x) => (
            <rect key={`${x}-${y}`} x={x} y={y} width="14" height="12" rx="2" fill={y === 62 && x === 76 ? "#ee5935" : "#cdd6df"} />
          ))
        )}
        ...
        <circle cx="178" cy="116" r="14" fill="#ee5935" />
  ...
  return (
    <svg viewBox="0 0 220 180" aria-label="Tax planning illustration" {...common}>
      <rect x="16" y="26" width="188" height="128" rx="20" fill="#ecf5fe" />
      <circle cx="40" cy="140" r="6" fill="#ee5935" fillOpacity="0.5" />
      ...
      <rect x="60" y="70" width="28" height="5" rx="2.5" fill="#ee5935" />
      {/* £ badge */}
      <circle cx="150" cy="58" r="24" fill="#ee5935" />
      ...
      {/* savings arrow */}
      <path d="M158 110v22m0 0l-7-7m7 7l7-7" stroke="#ee5935" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
