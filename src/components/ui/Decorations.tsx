...
export function DotCluster({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 60 60" aria-hidden className={className} fill="#ee5935">
...
export function RingAccent({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 80 80" aria-hidden className={className} fill="none">
      <circle cx="40" cy="40" r="34" stroke="#ee5935" strokeOpacity="0.35" strokeWidth="2" strokeDasharray="3 9" />
    </svg>
  );
}
...
export function PlusMark({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden className={className} fill="none">
      <path d="M12 4v16M4 12h16" stroke="#ee5935" strokeWidth="2.4" strokeLinecap="round" />
    </svg>
  );
}
